...
def plot_roc(data_obj,clf):
    ...
    #TODO this is a hack binarize on model initiation and rerun your grid search
    ...
    plt.xlabel('False Positive Rate')
    plt.ylabel('True Positive Rate')
    plt.title('Receiver operating characteristic '+data_obj.title)
    plt.legend(prop=dict(size=7))
    plt.savefig('plt_roc_'+str(data_obj.title)+'.png')
    # plt.show()
